...
const PopupTodo = ({ setShowConfirm, todoProps }) => {
    ...
    return (
        <section className='w-full fixed left-0 top-0 flex flex-col justify-center items-center h-screen'>
            <div
                className='w-full fixed left-0 top-0 h-screen'
            ...
            <div className='bg-white relative rounded-md'>
                ...
                <div className='p-6'>
                    <h4> Apakah kamu yakin mau hapus data {" "}
                        <strong>
                            {todoProps.name}
                        </strong> ?
                    </h4>
                    <div className='flex gap-2 justify-end items-center'>
                        <button className='px-4 py-2 text-sm bg-indigo-600 text-white rounded-md' onClick={handleDelete}>Ya, yakin</button>
